...
This project is about encapsulating dynamic behaviors that are common to many data visualizations. It is intended to be the foundation for authoring reusable interactive data visualization components.
